...
- Create a a virtual space that the drawing exists in and use the camera object to render that space in the canvas, (this will be needed later for the move/zoom feature).
- On refresh of the canvas component render and draw the drawing using the saved data.
...
- Add the translate and scale functions to allow for the move/zoom feature.
