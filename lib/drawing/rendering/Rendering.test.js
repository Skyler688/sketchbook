...
describe("Rendering class", () => {
    ...
    describe("rerender()", () => {
        it("should clear the canvas and call the render function", () => {
            ...
            const renderLineSegment_spy = vi.spyOn(utils, "renderLineSegment");
            ...
            expect(renderLineSegment_spy).toHaveBeenCalledTimes(line_seg_total);
    ...
    describe("drawLine()", () => {
        it("should draw a line and push point to the internal line.points", () => {
            ...
            expect(mock_drawing_bridge.get).toHaveBeenCalled();
            expect(renderLineSegment_spy).toHaveBeenCalled();
