...
describe("Rendering class", () => {
    ...
    beforeEach(() => {
        ...
        renderer = new Rendering(mock_drawing, mock_canvas);
    });
    ...
    describe("rerender()", () => {
        it("should clear the canvas and call the render functions", () => {
            ...
            vi.spyOn(renderer.drawing.drawing_bridge, "get").mockReturnValue({
                ...mock_drawing.drawing_bridge.get(),
                lines: test_lines,
            });
    ...
    describe("drawFirstPoint()", () => {
        it("should draw a circle and push the converted world point to the internal line.points.", () => {
            ...
            expect(mock_drawing.camera_bridge.get).toHaveBeenCalled();
            expect(mock_drawing.line_settings_bridge.get).toHaveBeenCalled();
    ...
    describe("drawLastPoint()", () => {
        it("should draw last point, push to the internal line, mutate the drawing_bridge, then set line to empty array", () => {
            ...
            expect(mock_drawing.drawing_bridge.mutate).toHaveBeenCalled();
        ...
        it("should return and do nothing if the amount of line points is 0", () => {
            ...
            expect(mock_drawing.camera_bridge.get).not.toHaveBeenCalled();
            expect(
                mock_drawing.line_settings_bridge.get,
            ).not.toHaveBeenCalled();
            expect(canvasToWorld_spy).not.toHaveBeenCalled();
            expect(renderLastPoint_spy).not.toHaveBeenCalled();
            expect(mock_drawing.drawing_bridge.mutate).not.toHaveBeenCalled();
        });
